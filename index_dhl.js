...
glob("/Users/Maxi/Downloads/DHL-Paketmarke_*.pdf", function (er, file) {
    globalThis.globFile = file;
    //debug 
    //console.log(globFile.join(''));
    console.log('found file:' + ' ' + globFile.join(''));

  });


//select label type
await page.select('#dienstleister', 'DHL_privat4');
...
await elementHandle.uploadFile(globFile.join(''));
